...
<head>
    ...
    <title>FrangoAssado.com Criar Pais</title>
        ...
        <form action="Controller.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="nome" id="nome" required maxlength="100" placeholder="nome do Pais">
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="area" id="area" required maxlength="60" placeholder="Ex: 250435602 M²">
                </div>
            </div>
            <hr />

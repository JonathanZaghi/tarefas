                    ...
                    <form action="Controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="numeric" class="form-control" name="populacao" id="populacao" maxlength="15"  placeholder="000000000000000" value="${pais.populacao}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Area</label>
                                <input type="numeric" class="form-control" name="area" id="area" required maxlength="60" placeholder="Ex: 2656.265.00M²" value="${pais.area}">
                            </div>
                        </div>
                        <hr />
